...
//    			HttpSession session,
//    			Model model, @ModelAttribute("editedOrder") Order order) 
//    {
//		if (session.getAttribute("user_id") == null)
//		{
//			return "redirect:/";
...
//
//		Order this_order = this.orderService.findOrderById(order_id);
//    	model.addAttribute("oldorder", this_order);
//  
//        return "editorder.jsp";
//    }
//    @RequestMapping(value="/editing/order", method=RequestMethod.POST)
//    public String editingOrder(@Valid @ModelAttribute("editedOrder") Order order,
//    							BindingResult result,
//    							HttpSession session,
//    							Model model)
//    {
...
//        	
//        	Order this_order = orderService.save(order);
//        	System.out.println(this_order.getId());
//        	return "redirect:/order/details/"+this_order.getId();
//        }
//    }
//	
